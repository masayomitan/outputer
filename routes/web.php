...
Route::get('books/put_new_sentence', 'BooksController@put_new_sentence')->name('books.put_new_sentence');
Route::get('books/put_popular_sentence', 'BooksController@put_popular_sentence')->name('books.put_popular_sentence');
